...
**Also if anyone is rocking a dual GPU system and would be willing to help me a bit, I have no idea how argus handles dual gpu so I have no idea whether the plugin will be able to handle it**
